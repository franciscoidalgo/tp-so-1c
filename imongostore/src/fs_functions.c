...
void generar_bitacora(char* id_patota, char* tripulante_id, char* entrada, int size_entrada);
...
char* generar_path_bitacora(char* patota_id, char* tripulante_id){
	char* file_name = string_from_format("Tripulante%s-%s.ims", patota_id, tripulante_id);
...
char* obtener_bitacora (char* patota_id, char* tripulante_id){
	t_config* bitacora;
